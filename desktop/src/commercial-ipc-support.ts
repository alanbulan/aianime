...
> {
  ...
  const contextWindow = firstPositiveInteger(
    ...
    parameterSchema.contextWindow,
    parameterSchema.context_window,
    parameterSchema.contextLength,
    parameterSchema.context_length,
    parameterSchema.maxModelLen,
    parameterSchema.max_model_len,
    parameterSchema.maxContextTokens,
    parameterSchema.max_context_tokens,
  );
  const maxOutputTokens = firstPositiveInteger(
    ...
    parameterSchema.outputTokenLimit,
    parameterSchema.output_token_limit,
    ...
    optionalRecord(parameterSchema.outputTokenLimit).maximum,
    optionalRecord(parameterSchema.output_token_limit).maximum,
    ...
    optionalRecord(properties.outputTokenLimit).maximum,
    optionalRecord(properties.output_token_limit).maximum,
