...
async def test_character_extraction_keeps_single_narrator_main(monkeypatch):
    ...
    from ai_anime.modules.knowledge_graph.infrastructure import pipeline
...
def test_first_person_narrator_copy_uses_narrator_main_terms(tmp_path):
    ...
    from ai_anime.modules.production.infrastructure.video_reference_voice import NARRATION_STYLES, resolve_narrator_source
