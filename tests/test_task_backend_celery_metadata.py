...
def test_shared_project_model_credits_are_attributed_to_requester():
    ...
    assert metrics_user_id_for_project_context(ctx) == "requester_user"
...
def test_model_credit_attribution_falls_back_to_owner_without_requester():
    ...
    assert metrics_user_id_for_project_context(ctx) == "owner_user"


def test_project_task_metrics_context_carries_shared_project_billing_metadata():
    calls = []
    ...
    set_project_task_metrics_context(usage_meter, ctx, "freezone_video_gen")
...
def test_freezone_ai_project_tasks_set_usage_resource_kind(task_type, resource_kind):
    calls = []
    ...
    set_project_task_metrics_context(usage_meter, ctx, task_type)
