...
def test_prop_requirements_reject_model_string_list_output():
    from ai_anime.modules.narrative_planning.infrastructure.asset_compiler_agent import BlockPropRequirements
...
def test_block_prop_prompt_explicitly_forbids_string_list_and_synonym_names():
    from ai_anime.modules.narrative_planning.infrastructure.asset_compiler_agent import BLOCK_PROP_PROMPT
