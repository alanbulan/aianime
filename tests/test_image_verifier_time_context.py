...
from ai_anime.modules.verification.image_verifier import ImageVerifier
from ai_anime.modules.verification.image_verifier import resolve_verification_scene_context
from ai_anime.modules.verification.models import VerificationResult
...
async def test_image_verifier_marks_time_baked_scene_as_locked_light(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("ai_anime.modules.verification.image_verifier.compress_image", lambda _p: b"jpeg")
