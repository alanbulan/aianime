...
describe("round 2 residual architecture boundaries", () => {
  it("establishes Creative Canvas as a real module owner", () => {
    ...
    const uploadNodeApplicationFiles = [
      "uploadNodeModel.ts",
      "uploadNodeModel.test.ts",
    ];
    const nodeActionApplicationFiles = [
      "nodeActionBeatContext.ts",
      "nodeActionBeatContext.test.ts",
    ];
    const toolbarApplicationFiles = [
    ...
    const uploadCanvasApplicationFiles = [
      "uploadCanvasAsset.ts",
      "uploadCanvasAsset.test.ts",
    ];
    const upstreamGraphApplicationFiles = [
      "graphContentResolver.ts",
      "graphImageResolver.ts",
    ];
    const skillExecutionApplicationFiles = [
      "skillExecution.ts",
      "skillExecution.test.ts",
    ];
    const defaultDataApplicationFiles = [
      "canvasNodeDefaultData.ts",
    ];
    const beatRefreshApplicationFiles = [
      "beatContextRefreshProjection.ts",
      "beatContextRefreshProjection.test.ts",
    ];
    const panoModelApplicationFiles = [
    ...
    const panoCaptureApplicationFiles = [
      "panoCaptureNodes.ts",
      "panoCaptureNodes.test.ts",
    ];
    const duplicationApplicationFiles = [
      "canvasNodeDuplication.ts",
      "canvasNodeDuplication.test.ts",
    ];
    const conversionApplicationFiles = [
      "canvasNodeConversion.ts",
      "canvasNodeConversion.test.ts",
    ];
    const scriptModelApplicationFiles = [
      "scriptNodeModel.ts",
      "scriptNodeModel.test.ts",
    ];
    const nodeCreationApplicationFiles = [
      "canvasNodeCreation.ts",
      "canvasNodeCreation.test.ts",
    ];
    const hydrationApplicationFiles = [
    ...
    const derivedCreationApplicationFiles = [
    ...
    const beatModelApplicationFiles = [
      "beatContextNodeModel.ts",
      "beatContextNodeModel.test.ts",
    ];
    const videoModelApplicationFiles = [
      "videoNodeModel.ts",
    ...
    const skillModelApplicationFiles = [
      "skillNodeModel.ts",
      "skillNodeModel.test.ts",
    ];
    const nodeFactoryApplicationFiles = [
      "nodeFactory.ts",
      "nodeFactory.test.ts",
    ];
    ...
    for (const file of catalogPresentationFiles) {
      expect(existsSync(resolve(moduleRoot, "presentation", file)), file).toBe(true);
    }
    expect(
    ...
    for (const retiredPath of [
      ...
      "features/canvas/application/uploadCanvasAsset.test.ts",
      "features/canvas/application/graphContentResolver.ts",
      "features/canvas/application/graphImageResolver.ts",
      "features/canvas/application/skillExecution.ts",
      "features/canvas/application/skillExecution.test.ts",
      ...
      "features/canvas/application/panoCaptureNodes.test.ts",
      "features/canvas/application/canvasNodeDuplication.ts",
      "features/canvas/application/canvasNodeDuplication.test.ts",
      "features/canvas/application/canvasNodeConversion.ts",
      "features/canvas/application/canvasNodeConversion.test.ts",
      ...
      "features/canvas/application/nodeFactory.test.ts",
    ...
    for (const file of uploadNodeApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of nodeActionApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of uploadCanvasApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of upstreamGraphApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of skillExecutionApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of defaultDataApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of beatRefreshApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of panoCaptureApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of duplicationApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of conversionApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of scriptModelApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of nodeCreationApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of derivedCreationApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of beatModelApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of skillModelApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
    ...
    for (const file of nodeFactoryApplicationFiles) {
      expect(existsSync(resolve(moduleRoot, "application", file)), file).toBe(
        true,
      );
      expect(
