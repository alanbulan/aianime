...
vi.mock("@/features/superchat/approval-card", () => ({
  ApprovalCard: ({
    approval,
    onResolve,
  }: {
...
vi.mock("@/features/superchat/pinned-messages-panel", () => ({
  PinnedPanel: ({
    messages,
    onClear,
    onTogglePin,
...
vi.mock("@/features/superchat/chat-search-bar", () => ({
  SearchBar: ({
    query,
    onChange,
    onClose,
...
import type { ApprovalRequest, ChatMessage } from "@/features/superchat/types";
