...
export const WORKBENCH_SELECT_CONTENT_CLASS =
  "!w-48 !min-w-48 rounded-md border border-white/10 bg-popover p-1 shadow-xl shadow-black/20 ring-0";

export const WORKBENCH_SELECT_ITEM_CLASS =
  "min-h-7 rounded-[4px] px-2 py-1 pr-8 text-[11px] focus:!bg-white/[0.08] focus:!text-current";
