...
function worldPayload(
  ...
  return {
    ...
    snapshot: params.snapshot as unknown as SceneDirectorWorldPayload["snapshot"],
...
function sourcePayload(
  ...
  return {
    ...
    snapshot: params.snapshot as unknown as SceneDirectorWorldSourcePayload["snapshot"],
