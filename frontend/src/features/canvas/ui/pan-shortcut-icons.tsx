...
// Accent marks follow the active canvas theme.
...
export function KeyboardPanIcon({ className }: PanIconProps) {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden className={className}>
      <rect x="9.5" y="6.5" width="13" height="19" rx="5.5" stroke="currentColor" />
      <path
  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden className={className}>
      ...
      <g clipPath="url(#clip0_trackpad_pan_shortcut)">
        <path d="M7 2.83594V11.1693" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8.25 9.91406L7 11.1641L5.75 9.91406" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M9.91797 5.75L11.168 7L9.91797 8.25" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M2.83203 7H11.1654" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M4.08203 5.75L2.83203 7L4.08203 8.25" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5.75 4.08594L7 2.83594L8.25 4.08594" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <defs>
...
export function MousePanIcon({ className }: PanIconProps) {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden className={className}>
      <rect x="13.5" y="8.5" width="13" height="19" rx="5.5" stroke="currentColor" />
      <rect x="19" y="12" width="2" height="5" rx="1" fill="rgb(var(--accent-rgb))" />
      <g clipPath="url(#clip0_mouse_pan_shortcut)">
        <path d="M8 3.83594V12.1693" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M9.25 10.9141L8 12.1641L6.75 10.9141" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10.918 6.75L12.168 8L10.918 9.25" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M3.83203 8H12.1654" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5.08203 6.75L3.83203 8L5.08203 9.25" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M6.75 5.08594L8 3.83594L9.25 5.08594" stroke="rgb(var(--accent-rgb))" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <defs>
