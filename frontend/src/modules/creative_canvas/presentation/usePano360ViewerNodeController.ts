...
import {
  ...
  type PanoDirection,
} from '../application/pano360ViewerNodeModel';
...
export interface Pano360ViewerNodeCanvasNode {
  id: string;
  type?: string | null;
...
export interface Pano360ViewerNodeStore {
  setSelectedNode: (id: string | null) => void;
  updateNodeData: (id: string, patch: Partial<Pano360ViewerNodeData>) => void;
  addPanoCaptureGroup: (
    sourceNodeId: string,
    captures: Array<{
      dataUrl: string;
...
export type Pano360ViewerNodeStoreHook = <TSelected>(
  selector: (state: Pano360ViewerNodeStore) => TSelected,
) => TSelected;

export type Pano360ViewerNodeUpstreamNodes = (
  nodeId: string,
) => Pano360ViewerNodeCanvasNode[];

export type Pano360ViewerNodeUploadLocalImage = (
  projectId: string,
  dataUrl: string,
  filename: string,
) => Promise<string>;

export type Pano360ViewerNodeCommitBackground = (
  projectId: string,
...
export function createUsePano360ViewerNodeController({
  useStore,
  useUpstreamNodes,
  uploadLocalImageToBackend,
  uploadAndAutoCommitSelectedBackgroundCandidate,
}: {
  useStore: Pano360ViewerNodeStoreHook;
  useUpstreamNodes: Pano360ViewerNodeUpstreamNodes;
  uploadLocalImageToBackend: Pano360ViewerNodeUploadLocalImage;
  uploadAndAutoCommitSelectedBackgroundCandidate: Pano360ViewerNodeCommitBackground;
}) {
  return function usePano360ViewerNodeController({
    projectId,
    id,
    data,
    selected,
...
export type Pano360ViewerNodeController = ReturnType<
  ReturnType<typeof createUsePano360ViewerNodeController>
>;
