  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#clip0_trackpad_pan_shortcut)">
        <path
          d="M7 2.83594V11.1693"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M8.25 9.91406L7 11.1641L5.75 9.91406"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M9.91797 5.75L11.168 7L9.91797 8.25"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M2.83203 7H11.1654"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M4.08203 5.75L2.83203 7L4.08203 8.25"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M5.75 4.08594L7 2.83594L8.25 4.08594"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#clip0_mouse_pan_shortcut)">
        <path
          d="M8 3.83594V12.1693"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M9.25 10.9141L8 12.1641L6.75 10.9141"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M10.918 6.75L12.168 8L10.918 9.25"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M3.83203 8H12.1654"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M5.08203 6.75L3.83203 8L5.08203 9.25"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M6.75 5.08594L8 3.83594L9.25 5.08594"
          stroke="rgb(var(--accent-rgb))"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
