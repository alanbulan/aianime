...
export type OutpaintEditorOverlayStoreHook = <TSelected>(
  selector: (state: OutpaintEditorOverlayStore) => TSelected,
) => TSelected;

export type OutpaintEditorOverlayUseImageModels = (
  projectId: string,
  purpose: 'edit',
) => { models: CanvasCatalogModelOption[] };

export type OutpaintEditorOverlayGenerateOutpaint = (
...
export function createOutpaintEditorOverlay({
  useStore,
  useCanvasImageModels,
  generateCanvasOutpaint,
}: {
  useStore: OutpaintEditorOverlayStoreHook;
  useCanvasImageModels: OutpaintEditorOverlayUseImageModels;
  generateCanvasOutpaint: OutpaintEditorOverlayGenerateOutpaint;
}) {
  return memo(
...
export type OutpaintEditorOverlay = ReturnType<
  typeof createOutpaintEditorOverlay
>;
