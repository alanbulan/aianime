...
import { registerFreezoneCanvasRuntime } from "@/modules/creative_canvas/application/canvasRuntimeState";
import { personalCanvasIdForUsername } from "@/modules/creative_canvas/domain/canvasIdentity";
import { openPresetProjectionInMyCanvas } from "@/modules/creative_canvas/presetProjectionComposition";

const buildProjectionFromPreset = vi.fn();

vi.mock("@/modules/creative_canvas/projectionComposition", async () => {
  const actual = await vi.importActual<
    typeof import("@/modules/creative_canvas/projectionComposition")
