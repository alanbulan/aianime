...
| 6. Asset & World | 进行中 | Style 前后端分层、Character Voice、Character Catalog、Identity CRUD、角色图片工作流与图片生成设置、前端资产工作台及后端 Prop/Scene Catalog、生成任务、媒体操作、Scene Viewer 与 Director World 已收敛，后续迁移其余后端资产用例 |
