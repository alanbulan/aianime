...
| 6. Asset & World | 进行中 | Style 前后端分层、Character Voice、Character Catalog、Identity CRUD、角色图片工作流、前端角色数据边界与 Character/Identity/Voice 工作台分层已收敛，后续迁移其余资产用例与页面 |
