...
_APP_MARKER = "_ai_anime_api_coverage_file"
_TESTCLIENT_ORIGINAL_INIT = "_ai_anime_api_coverage_original_init"
_ASGI_TRANSPORT_ORIGINAL_INIT = "_ai_anime_api_coverage_original_init"
...
def mount_api_coverage_middleware(app: FastAPI, coverage_file: str | None = None) -> bool:
    ...
    coverage_file = coverage_file or os.environ.get("AI_ANIME_API_COVERAGE_FILE")
