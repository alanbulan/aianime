...
=========================
    ...
    \"\"\"
    from ai_anime.modules.production.infrastructure.media_generation.scene_voxel.primitives import (
        VoxelScene,
        make_rng,
    )
...
async def generate_build_script(
    ...
    The returned string is the complete content of a build_script.py that:
        - imports from ai_anime.modules.production.infrastructure.media_generation.scene_voxel.primitives
