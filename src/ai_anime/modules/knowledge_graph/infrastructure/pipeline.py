...
from ai_anime.shared.time_of_day import LlmTimeOfDay
...
async def extract_characters_from_graph(
    ...
    # 注入人物设定上下文（辅助图谱，不替代）
    if novel_text:
        from ai_anime.modules.knowledge_graph.domain.script_parser import extract_synopsis
...
async def extract_scenes_from_script(
    ...
    """
    from ai_anime.modules.knowledge_graph.domain.script_parser import (
        extract_synopsis,
        parse_scenes,
    )
