"""Task state, worker, and scope identity rules."""
...
TASK_IDENTITY_SPECS: dict[str, TaskIdentitySpec] = {
    ...
    "grid_regenerate": TaskIdentitySpec(
        "grid_regen", include_episode=True, scope_mode="raw"
    ),
    "single_video": TaskIdentitySpec(
        "single_video", include_episode=True, include_beat=True
    ),
    "global_optimize_video": TaskIdentitySpec(
        "global_optimize_video", include_episode=True
    ),
    "sketch_generation": TaskIdentitySpec(
        "sketch_gen", include_episode=True, scope_mode="raw"
    ),
    "selected_regen": TaskIdentitySpec(
        "selected_regen", include_episode=True, scope_mode="raw"
    ),
    "sketch_regen": TaskIdentitySpec(
        "sketch_regen", include_episode=True, scope_mode="raw"
    ),
