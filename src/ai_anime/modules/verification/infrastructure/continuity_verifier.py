...
from ai_anime.modules.verification.application.models import ContinuityResult
from ai_anime.modules.verification.domain.prompts import SKETCH_CONTINUITY_PROMPT
