...
from ai_anime.modules.verification.application.models import VerificationResult
from ai_anime.modules.verification.domain.prompts import SKETCH_VERIFY_PROMPT
