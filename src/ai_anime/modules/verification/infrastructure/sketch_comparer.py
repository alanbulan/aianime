...
from ai_anime.modules.verification.application.models import CandidateRanking, CompareResult
from ai_anime.modules.verification.domain.prompts import SKETCH_COMPARE_PROMPT
from ai_anime.modules.verification.domain.sanitize import sanitize_prompt_input
