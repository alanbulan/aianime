...
from ai_anime.modules.verification.application.models import ObjectiveScore
from ai_anime.modules.verification.domain.prompts import SKETCH_SCORE_PROMPT
