...
Usage:
    uv run python -m ai_anime.modules.verification.presentation.cli.run_gate \
...
from ai_anime.modules.verification.infrastructure import convergence_log, failure_registry
from ai_anime.modules.verification.infrastructure.global_registry_db import open_defs_db
from ai_anime.modules.verification.infrastructure.sketch_visual_gate import (
    gate_candidate_cells,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("project_dir", help="AI anime project directory")
...
async def main_async() -> int:
    ...
    try:
        ...
        if source_run_id:
            from ai_anime.modules.verification.infrastructure import (
                replay_capture as _trace_mod,
            )
