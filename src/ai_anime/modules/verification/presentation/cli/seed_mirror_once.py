...
Usage::
    ...
    uv run python -m ai_anime.modules.verification.presentation.cli.seed_mirror_once \
        --user admin
    # or auto-detect all users under STATE_DIR:
    uv run python -m ai_anime.modules.verification.presentation.cli.seed_mirror_once --all-users
"""
