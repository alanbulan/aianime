...
Usage (first insert):
    ...
    uv run python -m ai_anime.modules.verification.presentation.cli.register_failure_mode \\
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--project-dir",
        required=True,
        help="AI anime project directory (used only to resolve the user-shared verification.db)",
    )
...
async def main_async() -> int:
    ...
    from ai_anime.modules.verification.infrastructure import failure_registry, version_hash
