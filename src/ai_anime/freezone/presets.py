...
FREEZONE_PRESET_DEFAULT_IMAGE_MODEL = DEFAULT_CREATIVE_CANVAS_IMAGE_MODEL
...
async def build_asset_preset_context(
    *,
    ...
    if asset_kind in {"identity", "portrait", "character"}:
        ...
        try:
            from ai_anime.config import IMAGE_DEFAULT_STYLE, get_style_preset
            from ai_anime.generators.nanobanana_character import NanoBananaCharacterGenerator
            from ai_anime.project_config import load_project_config
        ...
        generation_context["portrait"] = {
            "character": character,
            "prompt": _ai_anime_portrait_full_prompt(portrait_prompt) if portrait_prompt else "",
