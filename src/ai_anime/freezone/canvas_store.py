...
from ai_anime.freezone.canvas_lock import canvas_write_lock
from ai_anime.freezone.paths import canvas_path, canvases_dir
...
def prune_orphan_locks(project_dir: Path) -> list[Path]:
    ...
    from ai_anime.freezone.canvas_lock import canvas_locks_dir as _locks_dir
